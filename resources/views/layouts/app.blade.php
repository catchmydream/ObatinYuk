...
<body class="min-h-screen font-sans antialiased bg-base-200/50">
    ...
    <x-nav sticky class="glass-effect z-50">
        ...
        <x-slot:actions>
            @if(!request()->is('login') && !request()->is('register') && !request()->is('katalog') && !request()->is('search'))
            ...
            @auth
                ...
                <x-dropdown>
                    ...
                    <x-menu-item title="Profil Saya" icon="o-user" link="/profil" />
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            Livewire.on('swal:success', (data) => {
                let detail = data[0] || data;
                Swal.fire({
                    title: detail.title || 'Sukses!',
                    text: detail.text || '',
                    icon: 'success',
                    confirmButtonText: 'Tutup',
                    confirmButtonColor: 'var(--fallback-p,oklch(var(--p)/var(--tw-text-opacity)))',
                    timer: 3000,
            ...
            Livewire.on('swal:error', (data) => {
                ...
                Swal.fire({
                    ...
                    icon: 'error',
                    confirmButtonText: 'Tutup',
                    confirmButtonColor: 'var(--fallback-er,oklch(var(--er)/var(--tw-text-opacity)))'
                });
            });
        });
